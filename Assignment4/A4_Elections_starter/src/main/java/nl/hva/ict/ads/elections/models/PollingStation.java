...
public class PollingStation {
    ...
    public Map<Party, Integer> getVotesByParty() {
        ...
        //loops through each key-value pair in the votesByCandidate map
        for (Map.Entry<Candidate, Integer> entry : votesByCandidate.entrySet()) {
            ...
            if (votesByParty.containsKey(party)) {
                //if party already exists in map, add votes to current votes
                votesByParty.put(party, votesByParty.get(party) + votes);
            } else {
                //adds new entry
                votesByParty.put(party, votes);
            }
